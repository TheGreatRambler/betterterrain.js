/* Copyright THEGREATRAMBLER https://github.com/TheGreatRambler/betterterrain.js */
...
b.s2;return b.s2=a-(b.c=a|0)};b.c=1;b.s0=d(" ");b.s1=d(" ");b.s2=d(" ");b.s0-=d(c);0>b.s0&&(b.s0+=1);b.s1-=d(c);0>b.s1&&(b.s1+=1);b.s2-=d(c);0>b.s2&&(b.s2+=1);d=null}})();var g=function(a){"undefined"===typeof a&&(a={});"undefined"===typeof a.seed&&(a.seed=Math.random());"undefined"===typeof a.freq&&(a.freq=50);"undefined"===typeof a.defaultbiomechance&&(a.defaultbiomechance=80);"undefined"===typeof a.biomes&&(a.biomes={});"undefined"===typeof a.onlyheight&&(a.onlyheight=!1);"undefined"===typeof a.biomemap&&
(a.onlyheight=!0);"undefined"===typeof a.initialripple&&(a.initialripple=1);"undefined"===typeof a.continentmult&&(a.continentmult=2);"undefined"===typeof a.continentfreq&&(a.continentfreq=10);"undefined"===typeof a.moisturefreq&&(a.moisturefreq=2);"undefined"===typeof a.exponent&&(a.exponent=2);"undefined"===typeof a.invert&&(a.invert=!0);"undefined"===typeof a.moistureweight&&(a.moistureweight=1);a.structuresgen="undefined"===typeof a.structures?!1:!0;"undefined"===typeof a.chunksize&&(a.chunksize=
32);"undefined"===typeof a.defaultstucturesoverlap&&(a.defaultstucturesoverlap=!1);"undefined"===typeof a.defaultrequireddistanceseparated&&(a.defaultrequireddistanceseparated=0);a.createspecialstructs="undefined"===typeof a.specialstructs?!1:!0;this.rng=new d.alea(a.seed);this.terrainnoise=new d.rawnoise((new d.alea(this.rng.next())).next);this.continentnoise=new d.rawnoise((new d.alea(this.rng.next())).next);this.moisturenoise=new d.rawnoise((new d.alea(this.rng.next())).next);this.dataarray=[];
this.chunkexists=[];this.visitedriverchunks=[];this.options=a;a.createspecialstructs&&this.createspecialstructs()};d.getindex=function(a,c){var b=0<=a?2*a:-2*a-1,d=0<=c?2*c:-2*c-1;return b>=d?b*b+b+d:d*d+b};d.unpair=function(a){var c=Math.floor(Math.sqrt(a)),b=c*c;a=a-b>=c?[c,a-b-c]:[a-b,c];return[0===a[0]%2?a[0]/2:(a[0]+1)/2*-1,0===a[1]%2?a[1]/2:(a[1]+1)/2*-1]};d.getrandomnumber=function(a,c,b){return Math.floor(b*(c-a+1))+a};g.prototype.getchancefunc=function(a,c,b){var f=0;"undefined"!==typeof b&&
(f=b);a=(d.getindex(a,c)+this.options.seed+f)/1E6;return(new d.alea(a)).next};g.prototype._initxy=function(a,c){"undefined"===typeof this.dataarray[d.getindex(a,c)]&&(this.dataarray[d.getindex(a,c)]={})};g.prototype.createspecialstructs=function(){var a=this;this.options.specialstructs.forEach(function(c){var b=a.getchancefunc(c.x,c.y,3);b="[object Function]"===Object.prototype.toString.call(a.options.structures[c.name].data)?a.options.structures[c.name].data({x:c.x,y:c.y,c:(new d.alea(b())).next}):
a.options.structures[c.name].data;for(var f=b[0].length,m=b.length,e=0;e<f;e++)for(var g=0;g<m;g++){var h=c.x+e,l=c.y+g;a._initxy(h,l);a.dataarray[d.getindex(h,l)].i=b[g][e];a.dataarray[d.getindex(h,l)].s=c.name}})};g.prototype.generatestructures=function(a,c){if("undefined"===typeof this.dataarray[d.getindex(a,c)].s){var b=this.options.biomes[this.dataarray[d.getindex(a,c)].b];if("undefined"!==typeof b.structures){var f=this.getchancefunc(a,c,2),m=d.getrandomnumber(0,b.structures.length-1,f());m=
b.structures[m];if(100===m.chance||f()<=m.chance/100*b.structures.length){var e=this.options.structures[m.name];f="[object Function]"===Object.prototype.toString.call(e.data)?e.data({x:a,y:c,c:(new d.alea(f())).next}):e.data;b=f[0].length;var g=f.length,h=this.getchunkcoordinates(this.getchunkid(a+this.options.chunksize,c+this.options.chunksize));if(a+b<=h[0]&&c+g<=h[1])if("undefined"!==typeof e.allowedoverlap?e.allowedoverlap:this.options.defaultstucturesoverlap)for(e=0;e<b;e++)for(var l=0;l<g;l++){var n=
a+e,r=c+l;this._initxy(n,r);this.dataarray[d.getindex(n,r)].i=f[l][e];this.dataarray[d.getindex(n,r)].s=m.name}else{h=!0;var F="undefined"!==typeof e.requireddistance?e.requireddistance:this.options.defaultrequireddistanceseparated;for(e=0-F;e<b+F;e++)for(l=0-F;l<g+F;l++)if(n=a+e,r=c+l,this.dataarray[d.getindex(n,r)]||this._initxy(n,r),!this.dataarray[d.getindex(n,r)]||this.dataarray[d.getindex(n,r)].i)h=!1;if(h)for(e=0;e<b;e++)for(l=0;l<g;l++)n=a+e,r=c+l,f[l][e]&&(this.dataarray[d.getindex(n,r)].i=
f[l][e]),this.dataarray[d.getindex(n,r)].s=m.name}}}}};g.prototype.generatebiomes=function(a,c){if("undefined"===typeof this.dataarray[d.getindex(a,c)].b){var b=(this.dataarray[d.getindex(a,c)].m+1)/2;b=1<b||-1>b?1:b;var f=(this.dataarray[d.getindex(a,c)].h+1)/2;b=this.options.biomemap[this.options.biomemap.length-Math.floor(this.options.biomemap.length*(1<f||-1>f?1:f))-1][Math.floor(this.options.biomemap[0].length*b)];if("undefined"!==typeof this.options.biomes[b]&&"undefined"!==typeof this.options.biomes[b].childtiles){f=
this.getchancefunc(a,c,1);for(var m=this.options.biomes[b].childtiles,e=0;e<m.length;e++){var g=m[e].chance/100;if(f()<=g){b=m[e].name;break}}}this.dataarray[d.getindex(a,c)].b=b}};g.prototype.generatemoisture=function(a,c){if("undefined"===typeof this.dataarray[d.getindex(a,c)].m){var b=this.terrainnoise.noise2D(a/frequency,c/frequency),f=.5*this.terrainnoise.noise2D(2*a/frequency,2*c/frequency),g=.25*this.terrainnoise.noise2D(4*a/frequency,4*c/frequency);b=(b+f+g)*this.options.moistureweight;this.dataarray[d.getindex(a,
